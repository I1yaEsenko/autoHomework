...
const HW6 = () => {
    ...
    const restore = () => {
        // делают студенты
        let data = restoreState<string>('hw6-editable-span-value', value)
        let element = document.getElementById('hw6-editable-span')
        if (element !== null) element.textContent = data
        return value
    }
